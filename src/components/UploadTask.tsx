const UploadTask = () => {
  return (
    ...
    <div className="w-full max-w-xs sm:max-w-md md:max-w-lg bg-white p-6 rounded-lg shadow-lg">
      <h1 className="text-center font-bold text-4xl mb-4 font-mulish">
        Subir tarea
      </h1>
      ...
      <div className="flex justify-center">
        <button className="w-50 bg-blue-400 text-gray-50 py-2 cursor-pointer rounded-lg shadow-lg shadow-gray-500/50 active:shadow-none hover:opacity-60 active:opacity-60 font-mulish">
          Descargar enunciado
        </button>
      </div>
      ...
      <p className="mt-2 p-2 border-2 border-blue-900 rounded-lg text-left text-sm font-mulish"> File_01.zip</p>

      <div className="flex justify-center">
        <button className="w-50 bg-blue-400 cursor-pointer text-gray-50 py-2 rounded-lg mt-4 shadow-lg shadow-gray-500/50 active:shadow-none hover:opacity-60 active:opacity-60 font-mulish">
          Enviar tarea
        </button>
      </div>
    </div>
